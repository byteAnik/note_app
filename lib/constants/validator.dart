...
String? firstNameValidator(String? value) {
  ...
  if (!nameRegex.hasMatch(firstName)) {
    return 'First name can only contain letters, spaces, and dot (.)';
  }
...
String? lastNameValidator(String? value) {
  ...
  if (!nameRegex.hasMatch(lastName)) {
    return 'Last name can only contain letters, spaces, and dot (.)';
  }
...
String? passwordValidator1(String? value) {
  if (value == null || value.trim().isEmpty) {
